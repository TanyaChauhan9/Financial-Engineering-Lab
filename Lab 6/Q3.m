...
function compute_returns(stock_prices_d,stock_prices_w,stock_prices_m,stock_name)
    returns_daily = log((stock_prices_d(2:end)./stock_prices_d(1:end-1)));
    returns_weekly=log((stock_prices_w(2:end)./stock_prices_w(1:end-1)));
    returns_monthly=log((stock_prices_m(2:end)./stock_prices_m(1:end-1)));
